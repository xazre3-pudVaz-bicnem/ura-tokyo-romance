...
export const metadata: Metadata = {
  ...
  description:
    '東京の女風・女性用風俗の料金相場。60分¥1,200〜¥2,200、90分¥1,800〜¥3,200が目安です。料金はセラピストごとに異なります。詳細はセラピストのプロフィールをご確認ください。',
  alternates: { canonical: 'https://uratokyoromance.com/price' },
};

const marketPrices = [
  { time: '60分', low: '1,400', high: '2,000', note: '初めての方・お試しに' },
  { time: '90分', low: '2,200', high: '2,800', note: 'ゆっくり話したい方に' },
  { time: '120分', low: '3,000', high: '3,800', note: '特別な時間を2時間' },
  { time: '180分', low: '4,500', high: '5,500', note: 'じっくり過ごしたい方に' },
];

const extras = [
  { label: '指名料', price: '¥0〜¥500', desc: 'セラピストによって異なります（なしの方も）' },
  { label: '交通費', price: '実費またはエリア別', desc: '移動にかかる交通費は別途ご負担いただく場合があります' },
  { label: '延長（30分）', price: '¥800〜', desc: 'セラピストの空き状況によります。事前にご相談ください' },
];
